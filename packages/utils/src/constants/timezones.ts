export const TIMEZONES: {
   ...
   },
   {
      ...
      countryName: "Macao",
      countryCode: "MO",
      mainCities: ["Macau", "Taipa", "Luhuan", "Zhuojiacun"],
      rawOffsetInMinutes: 480,
      abbreviation: "CST",
      rawFormat: "+08:00 China Time - Macau, Taipa, Luhuan, Zhuojiacun",
   },
   {
      name: "Asia/Shanghai",
      alternativeName: "China Time",
   ...
   },
   {
      ...
      abbreviation: "AEST",
      rawFormat:
         "+10:00 Australian Eastern Time - Brisbane, Gold Coast, Sunshine Coast, Logan City",
   },
   {
